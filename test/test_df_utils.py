from src.utils.df_utils import remove_specfied_columns, add_prefix_to_table_name
import pandas as pd
import pytest
import datetime
...
class TestRemoveSpecifiedColumns:

    def test_empty_list_warns_user_and_returns_df_unchanged(self, dummy_df):
        columns_to_remove = []
        result = remove_specfied_columns(columns_to_remove, dummy_df)
